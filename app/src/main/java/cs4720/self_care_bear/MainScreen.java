...
public class MainScreen extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    //set up controls for fullScreen
    ...
    private final Runnable mHidePart2Runnable = new Runnable() {
        ...
        public void run() {
            ...
            homeScreenPage.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LOW_PROFILE
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeScreenPage.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // while interacting with the UI.
            ...
            findViewById(R.id.calendarTestButton).setOnTouchListener(mDelayHideTouchListener);
    }

    //This is all fullscreen controller stuff
    @Override
    ...
    private void show() {
        // Show the system bar
        homeScreenPage.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mVisible = true;
